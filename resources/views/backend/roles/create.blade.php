...
@section('content')
    <div class="htc__blog__area bg__white ptb--120">
        <div class="container">
            <h2 class="text-center mt-3">Create Role</h2>
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{ route('admin.roles.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name='display_name' class="form-control" id="display_name" value="{{ old('display_name') }}">
                            @error('display_name')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                            ...
                            <div class="panel-body tabs-menu-body main-content-body-right border">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="tab{{ $index }}">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" name="permission[]" id="{{ $action . '_' . $model }}" value="{{ $action . '_' . $model }}">
                        ...
                        <input type="submit" class="btn btn-primary mt-3 mb-3" value="Save">
                    </form>
                </div>
