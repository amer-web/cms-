					...
					<div class="main-header-right">
                        ...
                        <div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{ asset(auth()->user()->user_image )}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{ asset(auth()->user()->user_image ) }}" class=""></div>
											<div class="mr-3 my-auto ml-2">
												<h6 class="text-capitalize">{{ auth()->user()->username }}</h6><span class="text-capitalize">{{ auth()->user()->roles->first()->display_name }}</span>
											</div>
										</div>
									</div>
